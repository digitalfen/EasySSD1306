...
unsigned int Page::render(Adafruit_SSD1306 *display)
{
    ...
    else
    {
        ...
        display->print("Unknown page preset.");
        display->display();
        delay(2000);
...
unsigned int Page::presetPage1(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
...
unsigned int Page::presetPage2(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
...
unsigned int Page::presetPage3(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
...
unsigned int Page::presetPage4(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
...
unsigned int Page::presetPage5(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
...
unsigned int Page::presetPage6(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
...
unsigned int Page::presetPage7(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
...
unsigned int Page::presetPage8(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
...
unsigned int Page::presetPage9(Adafruit_SSD1306 *display)
{
    display->clearDisplay();
    int startIndex = DisplayManager::selectedItem;
    startIndex = constrain(startIndex, 0, text.size() - maxVisibleLines);
