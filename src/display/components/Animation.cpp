...
unsigned int Animation::render(Adafruit_SSD1306 *display)
{
    ...
    else if (preset == BOOT_PROGRESS)
    {
        presetIntro6(display);
    }
    ...
    else
    {
        ...
        display->print("Unknown animation request.");
        display->display();
        delay(3000);
    }
...
void Animation::presetIntro1(Adafruit_SSD1306 *display)
{
...
void Animation::presetIntro2(Adafruit_SSD1306 *display)
{
...
void Animation::presetIntro3(Adafruit_SSD1306 *display)
{
    const int textSize = 1;
    const int charWidth = 6 * textSize;                                // Largura de cada caractere
    const int charHeight = 8 * textSize;                               // Altura de cada caractere
...
void Animation::presetIntro4(Adafruit_SSD1306 *display)
{
    const int textSize = 1;
    const int charWidth = 6 * textSize;                                // Largura de cada caractere
    const int charHeight = 8 * textSize;                               // Altura de cada caractere
...
void Animation::presetIntro5(Adafruit_SSD1306 *display)
{
    const int textSize = 1;
    const int charWidth = 6 * textSize;                                // Largura de cada caractere
    const int charHeight = 8 * textSize;                               // Altura de cada caractere
...
void Animation::presetIntro6(Adafruit_SSD1306 *display)
{
...
void Animation::presetIntro7(Adafruit_SSD1306 *display)
{
    const int textSize = 1;
    const int charWidth = 6 * textSize;                                // Largura de cada caractere
    const int charHeight = 8 * textSize;                               // Altura de cada caractere
...
void Animation::presetIntro8(Adafruit_SSD1306 *display)
{
    const int textSize = 1;
    const int charWidth = 6 * textSize;                                // Largura de cada caractere
    const int charHeight = 8 * textSize;                               // Altura de cada caractere
